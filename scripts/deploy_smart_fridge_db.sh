...
SMART_FRIDGE_PIPELINE_LOCK_PATH=$SMART_FRIDGE_REMOTE_DIR/run/fridge-pipeline.lock
...
# YOLO is never allowed to become the semantic fallback for failed VLM inference.
sed -i 's/^SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR=.*/SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR=0/' \
  "$SMART_FRIDGE_REMOTE_DIR/config/smart_fridge.env"
sed -i 's/^SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT=.*/SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT=1/' \
  "$SMART_FRIDGE_REMOTE_DIR/config/smart_fridge.env"
...
SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR_OVERRIDE="${SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR-}"
SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT_OVERRIDE="${SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT-}"
SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE_OVERRIDE="${SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE-}"
SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE_OVERRIDE="${SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE-}"
SMART_FRIDGE_REMOVAL_CONFIRMATIONS_OVERRIDE="${SMART_FRIDGE_REMOVAL_CONFIRMATIONS-}"
SMART_FRIDGE_PIPELINE_LOCK_PATH_OVERRIDE="${SMART_FRIDGE_PIPELINE_LOCK_PATH-}"
...
if [ -n "$SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR_OVERRIDE" ]; then
  SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR="$SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR_OVERRIDE"
fi
if [ -n "$SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT_OVERRIDE" ]; then
  SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT="$SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT_OVERRIDE"
fi
if [ -n "$SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE_OVERRIDE" ]; then
  SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE="$SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE_OVERRIDE"
fi
if [ -n "$SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE_OVERRIDE" ]; then
  SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE="$SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE_OVERRIDE"
fi
if [ -n "$SMART_FRIDGE_REMOVAL_CONFIRMATIONS_OVERRIDE" ]; then
  SMART_FRIDGE_REMOVAL_CONFIRMATIONS="$SMART_FRIDGE_REMOVAL_CONFIRMATIONS_OVERRIDE"
fi
if [ -n "$SMART_FRIDGE_PIPELINE_LOCK_PATH_OVERRIDE" ]; then
  SMART_FRIDGE_PIPELINE_LOCK_PATH="$SMART_FRIDGE_PIPELINE_LOCK_PATH_OVERRIDE"
fi
...
: "${SMART_FRIDGE_PIPELINE_LOCK_PATH:=$ROOT/run/fridge-pipeline.lock}"
: "${SMART_FRIDGE_SENSOR_DEVICE:=auto}"
: "${SMART_FRIDGE_SENSOR_BAUD_RATE:=115200}"
...
export SMART_FRIDGE_WRITE_FALLBACK_ON_VLM_ERROR
export SMART_FRIDGE_VLM_USE_RESPONSE_FORMAT
export SMART_FRIDGE_YOLO_MIN_CONFIDENCE SMART_FRIDGE_YOLO_CHANGE_MIN_CONFIDENCE
export SMART_FRIDGE_CHANGE_HASH_MAX_DISTANCE SMART_FRIDGE_REMOVAL_CONFIRMATIONS
export SMART_FRIDGE_TMP_DIR SMART_FRIDGE_STATE_PATH SMART_FRIDGE_PIPELINE_LOCK_PATH
export SMART_FRIDGE_VLM_PROMPT_PATH
